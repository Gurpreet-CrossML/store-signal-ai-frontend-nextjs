...
import { ConnectedAccount, fetchMetaPages, fetchSocialPosts, SocialPost } from "@/redux/api-slice/social-ai-slice";
...
export default function SocialPostsFeed({ channelType }: { channelType: SocialChannel }) {
