...
export default function ThreadDetailDrawer({
    ...
    const { FetchThreadDetailsData, FetchThreadDetailsIsLoading } = useAppSelector(
        (state) => state.GetThreadReducer.FetchThreadDetailsState
    );
    const { FetchConversationSummaryData, FetchConversationSummaryIsLoading } = useAppSelector(
                    ...
                    <div className="flex flex-col gap-2">
                        <DrawerTitle className="flex items-center gap-2">
                            ...
                            <Badge
                                ...
                                {FetchThreadDetailsData?.verdict?.verdict == "resolved" ? "Resolved" : "Unresolved"}
                            </Badge>
                        </DrawerTitle>
                    ...
                    <div className="flex flex-row gap-2">
                        ...
                        <Card>
                            <CardContent>
                                ...
                                <CardDescription className="flex flex-col">
                                    {getDuration(FetchThreadDetailsData?.created_at, FetchThreadDetailsData?.ended_at) || "-"}
                                </CardDescription>
                            </CardContent>
                        </Card>
                        <Card>
