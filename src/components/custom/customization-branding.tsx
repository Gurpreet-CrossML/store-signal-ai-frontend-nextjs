    ...
    return (
        <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-3">
                ...
                {logoUrl && (
                    <Button variant="outline" size="sm" className="w-fit" onClick={onRemoveLogo}>
            ...
            <div className="flex flex-col gap-2">
                <Label htmlFor="welcome-message" className="flex items-center gap-2">
                    ...
                    Welcome Message
                    <span className="text-xs font-normal text-muted-foreground">(shown on home tab)</span>
                </Label>
                <Input
                    id="welcome-message"
            ...
            <div className="flex flex-col gap-2">
                <Label className="flex items-center gap-2">
                    <IconMessageCircle className="size-4" />
                    Greeting Message
                    <span className="text-xs font-normal text-muted-foreground">(shown when chat opens)</span>
                </Label>
