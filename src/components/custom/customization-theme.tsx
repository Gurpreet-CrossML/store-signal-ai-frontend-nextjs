...
export default function CustomizationTheme({
    ...
    const swatches = [
        { which: "primary" as const, label: "Primary color", color: themeColor, hex: themeHexInput, placeholder: "#6C5CE7" },
        { which: "secondary" as const, label: "Secondary color", color: secondaryColor, hex: secondaryHexInput, placeholder: "#F3F4F6" },
        { which: "tertiary" as const, label: "Tertiary color", color: tertiaryColor, hex: tertiaryHexInput, placeholder: "#DFE6E9" },
    ];
                    ...
                    {swatches.map(({ which, label, color, hex, placeholder }) => (
                        <div key={which} className="flex flex-col gap-2">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <Input
                                    value={hex}
                                    onChange={(event) => handleHexChange(which, event.target.value)}
