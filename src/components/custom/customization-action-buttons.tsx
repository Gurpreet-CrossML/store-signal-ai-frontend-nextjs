...
function AddActionButtonForm({ onAdd }: { onAdd: (button: ActionButton) => void }) {
        ...
        <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-3 border border-border p-4">
                <p className="text-xs text-muted-foreground">
                    Quick-action buttons shown in the chatbot. Uncheck to remove one, or add new ones below.
                </p>
                ...
                <div className="flex flex-col gap-2 border-t border-border pt-3">
                    <p className="text-xs font-medium text-muted-foreground">Add new action button</p>
                    <AddActionButtonForm
