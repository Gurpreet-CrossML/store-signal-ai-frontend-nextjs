...
export function SiteHeader() {
  ...
  const brandVoiceTitles: Record<string, string> = {
    "/brand-voice/persona-identity": "Persona Identity",
    "/brand-voice/never-say-rules": "Never-Say Rules",
  };
  const pageTitle = pathname
    ? (brandVoiceTitles[pathname] ?? findTitleFromPath(pathname))
    : null;
