    ...
    async (storeId: number, thunkAPI) => {
        try {
            ...
            toast.error("Uh oh! Something went wrong.", {
                description:
                    data?.message || "Unable to fetch customization metrics, please try again later.",
            });
...
export const CreateWidgetCustomization = createAsyncThunk(
    ...
    async ({ storeId, payload }: { storeId: number; payload: CreateWidgetCustomizationPayload; }, thunkAPI) => {
        try {
            const response = await axiosInstance.post(`${ENDPOINTS.widgetCustomization(storeId)}`, payload);
            const data = response.data.data;

            toast.success(response?.data?.message || "Widget customization created successfully");
            return data;
        } catch (error) {
            const response = isAxiosError(error) ? error.response : undefined;
            const data = response?.data;
            ...
            toast.error("Uh oh! Something went wrong.", {
                description:
                    data?.message || "Unable to create widget customization, please try again later.",
            });
...
export const UpdateWidgetCustomization = createAsyncThunk(
    ...
    async ({ storeId, payload }: { storeId: number; payload: UpdateWidgetCustomizationPayload; }, thunkAPI) => {
        try {
            const response = await axiosInstance.put(`${ENDPOINTS.widgetCustomization(storeId)}`, payload);
            const data = response.data.data;

            toast.success(response?.data?.message || "Widget customization updated successfully");
            return data;
        } catch (error) {
            const response = isAxiosError(error) ? error.response : undefined;
            const data = response?.data;
            ...
            toast.error("Uh oh! Something went wrong.", {
                description:
                    data?.message || "Unable to update widget customization, please try again later.",
            });
...
export const UpdateWidgetCustomizationWithImage = createAsyncThunk(
    ...
    async ({ storeId, payload, logoFile }: { storeId: number; payload: UpdateWidgetCustomizationPayload, logoFile: File; }, thunkAPI) => {
        try {
...
const CustomizationSlice = createSlice({
    ...
    initialState: {
        FetchWidgetCustomizationState: {
            ...
            FetchWidgetCustomizationData: null as null | WidgetCustomizationDataResponse,
        },
    ...
    extraReducers: (builder) => {
        builder
            .addCase(FetchWidgetCustomization.pending, (state) => {
                ...
                state.FetchWidgetCustomizationState.FetchWidgetCustomizationIsError = null;
            })
            .addCase(FetchWidgetCustomization.fulfilled, (state, action) => {
                ...
                state.FetchWidgetCustomizationState.FetchWidgetCustomizationData = action.payload;
            })
            .addCase(FetchWidgetCustomization.rejected, (state, action) => {
                state.FetchWidgetCustomizationState.FetchWidgetCustomizationIsLoading = false;
                state.FetchWidgetCustomizationState.FetchWidgetCustomizationIsSuccess = false;
                state.FetchWidgetCustomizationState.FetchWidgetCustomizationIsError = action.payload || "Something went wrong";
            })
            ...
            .addCase(CreateWidgetCustomization.pending, (state) => {
                ...
                state.CreateWidgetCustomizationState.CreateWidgetCustomizationIsError = null;
            })
            ...
            .addCase(CreateWidgetCustomization.rejected, (state, action) => {
                state.CreateWidgetCustomizationState.CreateWidgetCustomizationIsLoading = false;
                state.CreateWidgetCustomizationState.CreateWidgetCustomizationIsSuccess = false;
                state.CreateWidgetCustomizationState.CreateWidgetCustomizationIsError = action.payload || "Something went wrong";
            })
            ...
            .addCase(UpdateWidgetCustomization.pending, (state) => {
                ...
                state.UpdateWidgetCustomizationState.UpdateWidgetCustomizationIsError = null;
            })
            ...
            .addCase(UpdateWidgetCustomization.rejected, (state, action) => {
                state.UpdateWidgetCustomizationState.UpdateWidgetCustomizationIsLoading = false;
                state.UpdateWidgetCustomizationState.UpdateWidgetCustomizationIsSuccess = false;
                state.UpdateWidgetCustomizationState.UpdateWidgetCustomizationIsError = action.payload || "Something went wrong";
            })
            ...
            .addCase(UpdateWidgetCustomizationWithImage.pending, (state) => {
                ...
                state.UpdateWidgetCustomizationWithImageState.UpdateWidgetCustomizationWithImageIsError = null;
            })
            .addCase(UpdateWidgetCustomizationWithImage.fulfilled, (state, action) => {
            ...
            .addCase(UpdateWidgetCustomizationWithImage.rejected, (state, action) => {
                state.UpdateWidgetCustomizationWithImageState.UpdateWidgetCustomizationWithImageIsLoading = false;
                state.UpdateWidgetCustomizationWithImageState.UpdateWidgetCustomizationWithImageIsSuccess = false;
                state.UpdateWidgetCustomizationWithImageState.UpdateWidgetCustomizationWithImageIsError = action.payload || "Something went wrong";
            });
    },
});
