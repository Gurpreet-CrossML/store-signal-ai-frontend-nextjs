...
/**
 * Port of Django `PersonaIdentityAPIView` — GET only.
 * Serializer: PersonaIdentitySerializer.
 *  - GET -> Returns the persona identity configuration for the specified store.
 *
